...
// BEGIN: T5
    ...
    // Tenker å bruke assert() for å utløse unntak dersom filen ikke kan åpnes
    // 
    ifstream inputStream{filepath};
    std::vector<int> config = {60, 2};
    // inputStream << config << std:os;
    sim.applyConfiguration(config.at(0), config.at(1)); // kaller på funksjonen som legger det inn i simuleringen
// END: T5
}
